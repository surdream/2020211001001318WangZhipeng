...
<body>
<form action="form.jsp" class="form">
    <div class="div1">
        <span>New User Registration!</span>
    </div>
    <input type="text" class="Input" placeholder="Username" title="at least 8 characters">
    ...
    <input class="Input" placeholder="Date of Birth (yyyy-mm-dd)">
    <div class="div2">
...
<script>
    ...
    submit.onclick = function(){
        if(Username.value == ''){
            ...
            showTitle("Brith Cannot Be Empty")
            return false;
        }
    }
